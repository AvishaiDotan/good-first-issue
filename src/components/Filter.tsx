...
const DEFAULT_SIZES = {
	...
	padding: 2, // Reduced from 2
	spacing: 1.5, // Spacing between elements
	sliderHeight: 80, // Height for slider sections
	inputHeight: 55, // Height for input fields
} as const;
		...
		<ThemeProvider theme={customTheme}>
			<LocalizationProvider dateAdapter={AdapterDayjs}>
				...
				<Box sx={{
					...
					<Accordion>
						<AccordionSummary
							onClick={(e) => setIsAdvancedOpen(!isAdvancedOpen)}
